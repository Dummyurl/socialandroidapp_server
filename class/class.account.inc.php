...
class account extends db_connect
{
    ...
    public function signup($username, $fullname, $password, $email, $language = '')
    {
        ...
        $admob = $settings->getIntValue("admob");
        unset($settings);
    ...
    public function setPrivacySettings($allowShowMyPhotos, $allowShowMyGifts, $allowShowMyFriends, $allowShowMyVideos, $allowShowMyInfo)
    {
        $stmt = $this->db->prepare("UPDATE users SET allowShowMyPhotos = (:allowShowMyPhotos), allowShowMyGifts = (:allowShowMyGifts), allowShowMyFriends = (:allowShowMyFriends), allowShowMyVideos = (:allowShowMyVideos), allowShowMyInfo = (:allowShowMyInfo)  WHERE id = (:accountId)");
        $stmt->bindParam(":accountId", $this->id, PDO::PARAM_INT);
        $stmt->bindParam(":allowShowMyPhotos", $allowShowMyPhotos, PDO::PARAM_INT);
        ...
        $stmt->bindParam(":allowShowMyVideos", $allowShowMyVideos, PDO::PARAM_INT);
    ...
    public function getPrivacySettings()
    {
        ...
        $stmt = $this->db->prepare("SELECT allowShowMyPhotos, allowShowMyGifts, allowShowMyFriends, allowShowMyVideos, allowShowMyInfo FROM users WHERE id = (:id)");
        $stmt->bindParam(":id", $this->id, PDO::PARAM_INT);
...
//                $messages_count = $msg->getNewMessagesCount();
                ...
                $posts->setRequestFrom($this->getId());
    ...
    public function updateCounters()
    {
        ...
        $videosCount = $this->getVideosCount();
        ...
        $stmt = $this->db->prepare("UPDATE users SET posts_count = (:posts_count), photos_count = (:photos_count), videos_count = (:videos_count), gifts_count = (:gifts_count), likes_count = (:likes_count), friends_count = (:friends_count), following_count = (:following_count), followers_count = (:followers_count) WHERE id = (:accountId)");
        $stmt->bindParam(":accountId", $this->id, PDO::PARAM_INT);
        $stmt->bindParam(":posts_count", $postsCount, PDO::PARAM_INT);
        $stmt->bindParam(":photos_count", $photosCount, PDO::PARAM_INT);
        $stmt->bindParam(":videos_count", $videosCount, PDO::PARAM_INT);
    ...
    public function setVideosCount($videosCount)
    {
        ...
        $stmt = $this->db->prepare("UPDATE users SET videos_count = (:videos_count) WHERE id = (:accountId)");
        $stmt->bindParam(":accountId", $this->id, PDO::PARAM_INT);
        $stmt->bindParam(":videos_count", $videosCount, PDO::PARAM_INT);
